...
2. **An OpenSpec SDD showcase** — the repository is itself governed by
   ...
   constitutional protection, 35 ADRs, 6 capability specs, and a live change-management
...
│   ├── adr/                     #   35 Architecture Decision Records (ADR-0001–0035)
...
| [`openspec/adr/`](openspec/adr/) | 35 ADRs: framework choice → strict write-scope sandbox |
