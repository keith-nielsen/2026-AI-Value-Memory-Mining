...
2. **An OpenSpec SDD showcase** — the repository is itself governed by
   ...
   constitutional protection, 41 ADRs, 6 capability specs, and a live change-management
...
│   ├── adr/                     #   41 Architecture Decision Records (ADR-0001–0041)
...
| [`openspec/adr/`](openspec/adr/) | 41 ADRs: framework choice → local route pre-flight |
