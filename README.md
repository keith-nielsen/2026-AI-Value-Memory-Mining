...
[![OpenSpec](https://img.shields.io/badge/spec--driven-OpenSpec%20v1.6.0-blue)](openspec/project.md)
...
2. **An OpenSpec SDD showcase** — the repository is itself governed by
   [OpenSpec v1.6.0](openspec/project.md): a formal project spec, a constitution with
...
│   ├── 99-Operations/           #   Layer 0: 14 literate meta-scripts + schemas + config
...
This repo is governed by [OpenSpec v1.6.0](https://github.com/Fission-AI/OpenSpec)
