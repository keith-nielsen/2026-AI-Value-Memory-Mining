...
2. **An OpenSpec SDD showcase** — the repository is itself governed by
   ...
   constitutional protection, 36 ADRs, 6 capability specs, and a live change-management
...
│   ├── adr/                     #   36 Architecture Decision Records (ADR-0001–0036)
...
| [`openspec/adr/`](openspec/adr/) | 36 ADRs: framework choice → INV-7 secret scanning |
