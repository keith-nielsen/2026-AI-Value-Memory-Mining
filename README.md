...
2. **An OpenSpec SDD showcase** — the repository is itself governed by
   ...
   constitutional protection, 38 ADRs, 6 capability specs, and a live change-management
...
│   ├── adr/                     #   38 Architecture Decision Records (ADR-0001–0038)
...
| [`openspec/adr/`](openspec/adr/) | 38 ADRs: framework choice → required check contexts |
