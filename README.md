...
2. **An OpenSpec SDD showcase** — the repository is itself governed by
   ...
   constitutional protection, 30 ADRs, 6 capability specs, and a live change-management
...
│   ├── adr/                     #   30 Architecture Decision Records (ADR-0001–0030)
...
| [`openspec/adr/`](openspec/adr/) | 30 ADRs: framework choice → naming token floor |
