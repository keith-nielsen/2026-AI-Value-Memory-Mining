...
2. **An OpenSpec SDD showcase** — the repository is itself governed by
   ...
   constitutional protection, 29 ADRs, 6 capability specs, and a live change-management
...
│   ├── adr/                     #   29 Architecture Decision Records (ADR-0001–0029)
...
| [`openspec/adr/`](openspec/adr/) | 29 ADRs: framework choice → pillar slug tokens |
