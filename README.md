...
2. **An OpenSpec SDD showcase** — the repository is itself governed by
   ...
   constitutional protection, 33 ADRs, 6 capability specs, and a live change-management
...
│   ├── adr/                     #   33 Architecture Decision Records (ADR-0001–0033)
...
│                                #   ship-release.py: guarded tag→Release driver; pr-state.py: per-layer PR reporter)
│
...
| [`openspec/adr/`](openspec/adr/) | 33 ADRs: framework choice → Logbook write scope |
