...
2. **An OpenSpec SDD showcase** — the repository is itself governed by
   ...
   constitutional protection, 39 ADRs, 6 capability specs, and a live change-management
...
│   ├── adr/                     #   39 Architecture Decision Records (ADR-0001–0039)
...
| [`openspec/adr/`](openspec/adr/) | 39 ADRs: framework choice → declared-scope gate blocking |
