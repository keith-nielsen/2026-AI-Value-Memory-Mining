...
2. **An OpenSpec SDD showcase** — the repository is itself governed by
   ...
   constitutional protection, 40 ADRs, 6 capability specs, and a live change-management
...
│   ├── adr/                     #   40 Architecture Decision Records (ADR-0001–0040)
...
| [`openspec/adr/`](openspec/adr/) | 40 ADRs: framework choice → archive-on-branch convention |
