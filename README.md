...
2. **An OpenSpec SDD showcase** — the repository is itself governed by
   ...
   constitutional protection, 42 ADRs, 6 capability specs, and a live change-management
...
│   ├── adr/                     #   42 Architecture Decision Records (ADR-0001–0042)
...
| [`openspec/adr/`](openspec/adr/) | 42 ADRs: framework choice → the constitutional diff gate |
