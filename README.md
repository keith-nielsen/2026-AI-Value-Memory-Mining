...
2. **An OpenSpec SDD showcase** — the repository is itself governed by
   ...
   constitutional protection, 37 ADRs, 6 capability specs, and a live change-management
...
│   ├── adr/                     #   37 Architecture Decision Records (ADR-0001–0037)
...
| [`openspec/adr/`](openspec/adr/) | 37 ADRs: framework choice → INV-6 offline enforcement |
