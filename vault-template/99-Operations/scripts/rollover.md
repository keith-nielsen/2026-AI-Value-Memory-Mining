...
linking. Idempotent: skips any link already present. Produces exactly one commit if
any links were added; silent exit if nothing changed (no empty commits, INV-2).
