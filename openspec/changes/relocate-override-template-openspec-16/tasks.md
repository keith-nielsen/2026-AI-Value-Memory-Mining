...
- [ ] 4.1 `openspec validate relocate-override-template-openspec-16 --strict` + `openspec validate --all
      --strict` **under 1.6.0** green
- [ ] 4.2 `pytest tests/` green
- [ ] 4.3 adr-count guard (26 == 26, latest 0026) + constitution-lint + markdown/link/spec/runbook lints green

## 5. Gate 4 + release (human-gated)

- [ ] 5.1 Gate-4 sign-off recorded in `proposal.md`; ADR-0026 → Accepted
